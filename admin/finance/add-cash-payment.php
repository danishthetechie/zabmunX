                                ...
                                <table id="bootstrap-data-table" class="table table-responsive table-striped table-bordered" style="font-size:11px;">
									...
									<tbody>
										<?php
											...
											$query = "select * from delegates where del_id NOT IN (Select del_id from payments)";
										...
										<tr>
											...
											<td><?php echo $date; ?></td>
											<td>
												<a href = "addCash.php?id=<?php echo $id;?>"><button type="button" class="btn btn-success btn-sm"><i class="fa fa-magic"></i>&nbsp; Pay Cash</button></a>
											</td>
										</tr>
											<?php } 
											mysqli_close($con);
