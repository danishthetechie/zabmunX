                ...
                <div class="page-header float-right">
                    <div class="page-title">
                        <ol class="breadcrumb text-right">
                            ...
                            <li class="active">Add Remaining Payments</li>
                        </ol>
                    </div>
                </div>
            </div>
                                ...
                                <table id="bootstrap-data-table" class="table table-responsive table-striped table-bordered" style="font-size:11px;">
									...
									<tbody>
										<?php
											...
											$query = "select * from delegates d, payments p where d.del_id = p.del_id and p.balance != 0 and p.balance is not NULL";
										...
										<tr>
											...
											<td>
												<a href = "updateCash.php?id=<?php echo $id;?>"><button type="button" class="btn btn-success btn-sm"><i class="fa fa-magic"></i>&nbsp; Update Cash</button></a>
											</td>
										</tr>
											<?php } 
											mysqli_close($con);
