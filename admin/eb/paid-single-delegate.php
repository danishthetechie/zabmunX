                ...
                <div class="page-header float-right">
                    <div class="page-title">
                        <ol class="breadcrumb text-right">
                            ...
                            <li class="active">Paid Single Delegates</li>
                        </ol>
                    </div>
                </div>
            </div>
                    ...
                    <div class="col-md-12 col-xs-12">
                        <div class="card">
                            <div class="card-header">
                                <strong class="card-title">Paid Single Delegates</strong>
                            </div>
                            <div class="card-body">
                                <table id="bootstrap-data-table" class="table table-responsive table-striped table-bordered" style="font-size:11px;">
                                    ...
                                    <tbody>
										<?php
											...
											$query = "select DISTINCT d.* from delegates d, payments p where d.type = 0 and d.committee != 'disec' and d.committee != 'specpol' and d.del_id = p.del_id and p.status != 'Pending'";
