                ...
                <div class="page-header float-right">
                    <div class="page-title">
                        <ol class="breadcrumb text-right">
                            ...
                            <li><a href="#">Paid Registrations</a></li>
            ...
            <div class="animated">
                ...
                <div class="card">
                    <div class="card-header">
                        ...
                        <strong class="card-title" v-if="headerText">Team Delegations</strong>
					</div>
                    <div class="card-body">
						<?php
							$useremail = $_SESSION['email'];
							$count = 1;
							$query = "select DISTINCT d.* from delegates d, payments p where d.type = 1 and d.del_id = p.del_id and p.status != 'Pending'";
                    ...
                    <div class="card-body">
						<?php
							$count1 = 1;
							$query3 = "";
							$query3 = "select DISTINCT d.* from delegates d, payments p where type = 0 and (d.committee = 'disec' or d.committee = 'specpol') and d.del_id = p.del_id and p.status != 'Pending'";
								...
								<table id="bootstrap-data-table" class="table table-responsive table-striped table-bordered" style="font-size:11px;">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td><?php echo $mfname1." ".$mlname1; ?></td>
